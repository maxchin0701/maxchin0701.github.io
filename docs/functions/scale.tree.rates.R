...
scaleTreeRates <- function(tree,tip.states,
  ...
  # model: model for likelihood calculation or character (any argument that fitMk takes) or matrix
  # fixedQ: Qmatrix with pre-estimated rates, defaults to Null (rates will be estimated using fitMk)
  # max.ratio: maximum ratio of scalars to one, integer, default is 2
